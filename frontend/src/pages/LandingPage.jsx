...
const LandingPage = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0 ">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                ...
                <span className=" bg-clip-text bg-[radial-gradient(circle, _#FF9324_0%, _#FCD760_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">
                  AI powered
                </span>{" "}
                Learning
              </h1>
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                deeper into concepts, and organise everything your way. From
      ...
      <div className="w-full m-h-full relative z-10 ">
        <div >
